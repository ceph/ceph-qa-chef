...
if !node['hostname'].match(/^(plana|burnupi|mira|vpm|tala|saya|dubia|apama|rhoda)/)
 raise "This recipe is only intended for plana/burnupi/mira/vpm/tala/saya/dubia/apama hosts"
end
